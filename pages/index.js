...
const Index = () => {
  ...
  return (
    ...
    <div className='bg-blue-500 w-screen h-screen flex flex-col justify-center items-center'>
      ...
      <div className={`w-1/2 h-1/2 bg-blue-300 flex flex-col justify-center items-center animate__animated ${animate?"animate__zoomOutDown":""}`}>
      <h1 className='text-white text-2xl font-mono mb-10 uppercase'>Enter Contest</h1>
       <div className="flex flex-col justify-center items-center">
          ...
          <Button type="primary" onClick={()=>{setTimeout(()=>{setAnimate(true)},1000); router.push("/home")}} className='mt-10'>Sign In</Button>
      </div>
      </div>
    </div>
    </>
